 ...
 * 
 * @export
 * @interface ChangeGraphVersionRequest
 */
export interface ChangeGraphVersionRequest {
    /**
     * 
     * @type {string}
     * @memberof ChangeGraphVersionRequest
     */
    'version_id': string;
}
/**
 ...
 * 
 * @export
 * @interface CreateGraphByPgqlRequest
 */
export interface CreateGraphByPgqlRequest {
    /**
     * 
     * @type {string}
     * @memberof CreateGraphByPgqlRequest
     */
    'name'?: string;
    /**
     * 
 ...
 * 
 * @export
 * @interface CreateGraphByYamlRequest
 */
export interface CreateGraphByYamlRequest {
    /**
     * 
     * @type {string}
     * @memberof CreateGraphByYamlRequest
     */
    'name'?: string;
    /**
     * 
 ...
 * 
 * @export
 * @interface GetGraphVersionResponse
 */
export interface GetGraphVersionResponse {
    /**
     * 
     * @type {string}
     * @memberof GetGraphVersionResponse
     */
    'creation_time': string;
    /**
     * 
...
export const GraphApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        /**
         * Create a new graph by providing pgql
         * @param {CreateGraphByPgqlRequest} createGraphByPgqlRequest 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createGraphByPgql: async (createGraphByPgqlRequest: CreateGraphByPgqlRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'createGraphByPgqlRequest' is not null or undefined
            assertParamExists('createGraphByPgql', 'createGraphByPgqlRequest', createGraphByPgqlRequest)
            const localVarPath = `/api/v1/graph/pgql`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(createGraphByPgqlRequest, localVarRequestOptions, configuration)
        ...
        /**
         * Create a new graph by providing yaml
         * @param {CreateGraphByYamlRequest} createGraphByYamlRequest 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createGraphByYaml: async (createGraphByYamlRequest: CreateGraphByYamlRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'createGraphByYamlRequest' is not null or undefined
            assertParamExists('createGraphByYaml', 'createGraphByYamlRequest', createGraphByYamlRequest)
            const localVarPath = `/api/v1/graph/yaml`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(createGraphByYamlRequest, localVarRequestOptions, configuration)
        ...
        /**
         * Get all available versions for a specific graph
         * @param {string} graphId 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getGraphAllAvailableVersions: async (graphId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'graphId' is not null or undefined
            assertParamExists('getGraphAllAvailableVersions', 'graphId', graphId)
            const localVarPath = `/api/v1/graph/{graph_id}/version`
                .replace(`{${"graph_id"}}`, encodeURIComponent(String(graphId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
        ...
        /**
         * Get the latest version by providing a timestamp
         * @param {string} graphId 
         * @param {string} timestamp 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getGraphVersionByTimestamp: async (graphId: string, timestamp: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'graphId' is not null or undefined
            assertParamExists('getGraphVersionByTimestamp', 'graphId', graphId)
            // verify required parameter 'timestamp' is not null or undefined
            assertParamExists('getGraphVersionByTimestamp', 'timestamp', timestamp)
            const localVarPath = `/api/v1/graph/{graph_id}/version/{timestamp}`
                .replace(`{${"graph_id"}}`, encodeURIComponent(String(graphId)))
        ...
        /**
         * Read graph by a given version
         * @param {string} graphId 
         * @param {ChangeGraphVersionRequest} changeGraphVersionRequest 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        readGraphByAGivenVersion: async (graphId: string, changeGraphVersionRequest: ChangeGraphVersionRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'graphId' is not null or undefined
            assertParamExists('readGraphByAGivenVersion', 'graphId', graphId)
            // verify required parameter 'changeGraphVersionRequest' is not null or undefined
            assertParamExists('readGraphByAGivenVersion', 'changeGraphVersionRequest', changeGraphVersionRequest)
            const localVarPath = `/api/v1/graph/{graph_id}/version`
                .replace(`{${"graph_id"}}`, encodeURIComponent(String(graphId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(changeGraphVersionRequest, localVarRequestOptions, configuration)
...
export const GraphApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async createGraphByPgql(createGraphByPgqlRequest: CreateGraphByPgqlRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreateGraphResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createGraphByPgql(createGraphByPgqlRequest, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['GraphApi.createGraphByPgql']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Create a new graph by providing yaml
         ...
         * @throws {RequiredError}
         */
        async createGraphByYaml(createGraphByYamlRequest: CreateGraphByYamlRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreateGraphResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createGraphByYaml(createGraphByYamlRequest, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['GraphApi.createGraphByYaml']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Create a vertex type
         ...
         * @throws {RequiredError}
         */
        async getGraphAllAvailableVersions(graphId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<GetGraphVersionResponse>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getGraphAllAvailableVersions(graphId, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['GraphApi.getGraphAllAvailableVersions']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Get graph by ID
         ...
         * @throws {RequiredError}
         */
        async getGraphVersionByTimestamp(graphId: string, timestamp: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetGraphVersionResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getGraphVersionByTimestamp(graphId, timestamp, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['GraphApi.getGraphVersionByTimestamp']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Get graph schema by ID
         ...
         * @throws {RequiredError}
         */
        async readGraphByAGivenVersion(graphId: string, changeGraphVersionRequest: ChangeGraphVersionRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.readGraphByAGivenVersion(graphId, changeGraphVersionRequest, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['GraphApi.readGraphByAGivenVersion']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
    }
};
...
export const GraphApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createGraphByPgql(createGraphByPgqlRequest: CreateGraphByPgqlRequest, options?: any): AxiosPromise<CreateGraphResponse> {
            return localVarFp.createGraphByPgql(createGraphByPgqlRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * Create a new graph by providing yaml
         * @param {CreateGraphByYamlRequest} createGraphByYamlRequest 
         ...
         * @throws {RequiredError}
         */
        createGraphByYaml(createGraphByYamlRequest: CreateGraphByYamlRequest, options?: any): AxiosPromise<CreateGraphResponse> {
            return localVarFp.createGraphByYaml(createGraphByYamlRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * Create a vertex type
         * @param {string} graphId 
         ...
         * @throws {RequiredError}
         */
        getGraphAllAvailableVersions(graphId: string, options?: any): AxiosPromise<Array<GetGraphVersionResponse>> {
            return localVarFp.getGraphAllAvailableVersions(graphId, options).then((request) => request(axios, basePath));
        },
        /**
         * Get graph by ID
         * @param {string} graphId 
         ...
         * @throws {RequiredError}
         */
        getGraphVersionByTimestamp(graphId: string, timestamp: string, options?: any): AxiosPromise<GetGraphVersionResponse> {
            return localVarFp.getGraphVersionByTimestamp(graphId, timestamp, options).then((request) => request(axios, basePath));
        },
        /**
         * Get graph schema by ID
         * @param {string} graphId 
         ...
         * @throws {RequiredError}
         */
        readGraphByAGivenVersion(graphId: string, changeGraphVersionRequest: ChangeGraphVersionRequest, options?: any): AxiosPromise<string> {
            return localVarFp.readGraphByAGivenVersion(graphId, changeGraphVersionRequest, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class GraphApi extends BaseAPI {
     ...
     * @memberof GraphApi
     */
    public createGraphByPgql(createGraphByPgqlRequest: CreateGraphByPgqlRequest, options?: RawAxiosRequestConfig) {
        return GraphApiFp(this.configuration).createGraphByPgql(createGraphByPgqlRequest, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof GraphApi
     */
    public createGraphByYaml(createGraphByYamlRequest: CreateGraphByYamlRequest, options?: RawAxiosRequestConfig) {
        return GraphApiFp(this.configuration).createGraphByYaml(createGraphByYamlRequest, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof GraphApi
     */
    public getGraphAllAvailableVersions(graphId: string, options?: RawAxiosRequestConfig) {
        return GraphApiFp(this.configuration).getGraphAllAvailableVersions(graphId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof GraphApi
     */
    public getGraphVersionByTimestamp(graphId: string, timestamp: string, options?: RawAxiosRequestConfig) {
        return GraphApiFp(this.configuration).getGraphVersionByTimestamp(graphId, timestamp, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof GraphApi
     */
    public readGraphByAGivenVersion(graphId: string, changeGraphVersionRequest: ChangeGraphVersionRequest, options?: RawAxiosRequestConfig) {
        return GraphApiFp(this.configuration).readGraphByAGivenVersion(graphId, changeGraphVersionRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const JobApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        pauseJob: async (jobId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'jobId' is not null or undefined
            assertParamExists('pauseJob', 'jobId', jobId)
            const localVarPath = `/api/v1/job/{job_id}/pause`
                .replace(`{${"job_id"}}`, encodeURIComponent(String(jobId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        resumeJob: async (jobId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'jobId' is not null or undefined
            assertParamExists('resumeJob', 'jobId', jobId)
            const localVarPath = `/api/v1/job/{job_id}/resume`
                .replace(`{${"job_id"}}`, encodeURIComponent(String(jobId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const JobApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async pauseJob(jobId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.pauseJob(jobId, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['JobApi.pauseJob']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Resume an existing job
         ...
         * @throws {RequiredError}
         */
        async resumeJob(jobId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.resumeJob(jobId, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['JobApi.resumeJob']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Submit a dataloading job
...
export const JobApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        pauseJob(jobId: string, options?: any): AxiosPromise<string> {
            return localVarFp.pauseJob(jobId, options).then((request) => request(axios, basePath));
        },
        /**
         * Resume an existing job
         * @param {string} jobId 
         ...
         * @throws {RequiredError}
         */
        resumeJob(jobId: string, options?: any): AxiosPromise<string> {
            return localVarFp.resumeJob(jobId, options).then((request) => request(axios, basePath));
        },
        /**
         * Submit a dataloading job
         * @param {string} graphId 
...
export class JobApi extends BaseAPI {
     ...
     * @memberof JobApi
     */
    public pauseJob(jobId: string, options?: RawAxiosRequestConfig) {
        return JobApiFp(this.configuration).pauseJob(jobId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof JobApi
     */
    public resumeJob(jobId: string, options?: RawAxiosRequestConfig) {
        return JobApiFp(this.configuration).resumeJob(jobId, options).then((request) => request(this.axios, this.basePath));
    }
...
export const ServiceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        pauseDataLoading: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/v1/service/pause`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        resumeDataLoading: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/v1/service/resume`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
export const ServiceApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async pauseDataLoading(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.pauseDataLoading(options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['ServiceApi.pauseDataLoading']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Restart current service
         ...
         * @throws {RequiredError}
         */
        async resumeDataLoading(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.resumeDataLoading(options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['ServiceApi.resumeDataLoading']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Start service
...
export const ServiceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        pauseDataLoading(options?: any): AxiosPromise<string> {
            return localVarFp.pauseDataLoading(options).then((request) => request(axios, basePath));
        },
        /**
         * Restart current service
         * @param {*} [options] Override http request option.
         ...
         * @throws {RequiredError}
         */
        resumeDataLoading(options?: any): AxiosPromise<string> {
            return localVarFp.resumeDataLoading(options).then((request) => request(axios, basePath));
        },
        /**
         * Start service
         * @param {StartServiceRequest} [startServiceRequest] 
...
export class ServiceApi extends BaseAPI {
     ...
     * @memberof ServiceApi
     */
    public pauseDataLoading(options?: RawAxiosRequestConfig) {
        return ServiceApiFp(this.configuration).pauseDataLoading(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ServiceApi
     */
    public resumeDataLoading(options?: RawAxiosRequestConfig) {
        return ServiceApiFp(this.configuration).resumeDataLoading(options).then((request) => request(this.axios, this.basePath));
    }
