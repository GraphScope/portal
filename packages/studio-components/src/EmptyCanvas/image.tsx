...
export default ({ style }: { style?: React.CSSProperties }) => {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 915 866" fill="none" style={style}>
      ...
      <circle cx="735.006" cy="235.789" r="12.5406" transform="rotate(30 735.006 235.789)" fill={stroke} />
      <circle cx="800.535" cy="288.103" r="12.5406" transform="rotate(30 800.535 288.103)" fill={stroke} />
      <circle cx="613.406" cy="199.774" r="12.5406" transform="rotate(30 613.406 199.774)" fill={stroke} />
      ...
      <circle cx="385" cy="219" r="7" fill={stroke} />
      <circle cx="414" cy="190" r="7" fill={stroke} />
      <line x1="282.78" y1="228.551" x2="333.78" y2="203.551" stroke={stroke} />
      <line x1="384.859" y1="219.48" x2="333.859" y2="204.48" stroke={stroke} />
      <line x1="384.647" y1="218.646" x2="413.647" y2="189.646" stroke={stroke} />
      <line x1="384.53" y1="219.169" x2="360.53" y2="152.169" stroke={stroke} />
