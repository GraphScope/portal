...
- **Navigator**: The Navigator abstraction determines how related papers can be fetched and processed via the Inspector. Currently, two navigators are available:
    - [Arxiv Navigator](./utils/arxiv_fetcher.py) for retrieving PDFs from ArXiv.
	- [Google Scholar Navigator](./utils/scholar_fetcher.py) for fetching PDFs via Google Scholar.
